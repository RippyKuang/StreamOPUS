...
train_pipeline = [
    ...
    dict(type='Collect3D', keys=['img', 'voxel_semantics', 'mask_camera'], meta_keys=(
        'filename', 'ori_shape', 'img_shape', 'pad_shape', 'lidar2img', 'img_timestamp', 'lidar2global','prev_exists','scene_name','ego2lidar'))
]
...
# checkpointing
checkpoint_config = dict(interval=num_iters_per_epoch, max_keep_ckpts=total_epochs)
...
# evaluation
eval_config = dict(interval=total_epochs*num_iters_per_epoch)
